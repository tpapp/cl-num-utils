              ...
              (reduce (lambda (i1 i2) (aref matrix i1 i2)) objects
                      :key (lambda (object)
                             (cond
                               ...
                               ((typep object 'short-float) 0)
                               ((typep object 'single-float) 1)
                               ((typep object 'double-float) 2)
                               ((typep object 'long-float) 3)
                               ((typep object '(complex short-float)) 4)
                               ((typep object '(complex single-float)) 5)
                               ((typep object '(complex double-float)) 6)
                               ((typep object '(complex long-float)) 7)
                               (t (return-from elementwise-float-contagion t))))))
        nil)))
